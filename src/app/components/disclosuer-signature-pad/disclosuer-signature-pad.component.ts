...
@Component({
  selector: 'app-disclosuer-signature-pad',
  templateUrl: './disclosuer-signature-pad.component.html',
  styleUrls: ['./disclosuer-signature-pad.component.scss']
})
export class DisclosuerSignaturePadComponent implements OnInit {
