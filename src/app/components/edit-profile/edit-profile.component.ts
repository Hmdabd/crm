...
export class EditProfileComponent implements OnInit {
    ...
    initCompanyForm(): void {
        this.companyForm = this.fb.group({
            ...
            time_zone_id: [''],
            date_format_id: [''],
            submission_email: ['', [Validators.pattern(Custom_Regex.spaces), Validators.pattern(Custom_Regex.email),]],
            ...
            syndication_email: ['', [Validators.pattern(Custom_Regex.spaces), Validators.pattern(Custom_Regex.email),]],
            support_email: ['', [Validators.pattern(Custom_Regex.spaces), Validators.pattern(Custom_Regex.email),]],
        })
    }
    ...
    patchValues(): void {
        ...
        if (this.userRole === Roles.COMPANY || this.userRole === Roles.ADMINISTRATOR) {
            this.companyForm.patchValue({
                ...
                submission_email: this.userDetails.submission_email,
                ...
                syndication_email: this.userDetails.syndication_email,
                support_email: this.userDetails.support_email,
            })
        } else {
    ...
    imagePreview2(e: any, i: any) {
        ...
        if (mimeTypees.includes(file.type)) {
            ...
            if (this.selectedFile2.size < 10000000) {
                const reader = new FileReader();
                reader.onload = () => {
            ...
            reader.onload = () => {
                this.filePath2 = reader.result as string;
                this.userDetails.logo = this.filePath2;
            }
            ...
            if (ud) {
                ...
                if (this.userRole === Roles.COMPANY || this.userRole === Roles.ADMINISTRATOR) {
                    ...
                    user = {
                        ...
                        time_zone: object2?.conversion_zone,
    ...
    async submitForm() {
        try {
            ...
            if (this.userRole !== Roles.COMPANY && this.userRole !== Roles.ADMINISTRATOR) {
                ...
                formData.append('first_name', this.editProfileForm.get('first_name').value);
                formData.append('last_name', this.editProfileForm.get('last_name').value);
                formData.append('phone_number', this.editProfileForm.get('phone_number').value);
                ...
                formData.append('state_id', this.editProfileForm.get('state_id').value);
                formData.append('country_id', this.editProfileForm.get('country_id').value);
                formData.append('fax', this.editProfileForm.get('fax').value);
                formData.append('zip_code', this.editProfileForm.get('zip_code').value);
                formData.append('time_zone_id', this.editProfileForm.get('time_zone_id').value);
                formData.append('date_format_id', this.editProfileForm.get('date_format_id').value);
                formData.append('sip_extension', this.editProfileForm.get('sip_extension').value);
                formData.append('sms_extension', this.editProfileForm.get('sms_extension').value);
                formData.append('sip_password', this.editProfileForm.get('sip_password').value);
                if (this.selectedFile2) {
                    formData.append('logo', this.selectedFile2);
                }
                data = formData;
            } else {
                const formData = new FormData();
                ...
                formData.append('submission_email', this.companyForm.get('submission_email').value);
                ...
                formData.append('syndication_email', this.companyForm.get('syndication_email').value);
                formData.append('support_email', this.companyForm.get('support_email').value);
    ...
    getNtfctionClr() {
        const tds = document.getElementsByClassName('custom-control-label') as HTMLCollectionOf<HTMLElement>;
