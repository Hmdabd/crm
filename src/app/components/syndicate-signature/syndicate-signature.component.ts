...
@Component({
    selector: 'app-syndicate-signature',
    templateUrl: './syndicate-signature.component.html',
    styleUrls: ['./syndicate-signature.component.scss']
})
export class SyndicateSignatureComponent implements OnInit {
