...
export class AgentListComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.getAgentList();
        this.canAddAgent = this.authService.hasPermission('partner-add');
        this.canViewAgent = this.authService.hasPermission('partner-view');
        this.canEditAgent = this.authService.hasPermission('partner-update');
        this.canDeleteAgent = this.authService.hasPermission('partner-delete');
    }
    ngDoCheck(): void {
 ...
 */
  ...
  */
    ...
    /**
  * @description get Agent list eg company list if broker company is logged in
  */
