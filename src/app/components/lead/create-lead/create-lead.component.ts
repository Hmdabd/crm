...
export class CreateLeadComponent implements OnInit {
    ...
    showFirstLastNameRequired:boolean =  false;
    ...
    ngOnInit(): void {
        ...
        if(this.userDetails?.company_type == 'broker'){
            ...
            //Owner 1 first & last name mandatory for broker case
            //please uncomment while make owner mandatory
        ...
        // please update to funding company now on always true
    ...
    initOfficerInfoForm() {
        this.officerInfoForm = this.fb.group({
            ...
            // Validators.minLength(3),
            officer_zip: [''],
            officer_dl:['',[Validators.pattern(/^[a-zA-Z0-9]+$/)]],
            officer_job_title:[''],
            // , [Validators.pattern(Custom_Regex.digitsOnly)]
            officer_ssn: [''],
            officer_cell: [''],
