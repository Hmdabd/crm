...
export class LeadUpdatesComponent implements OnInit {
    ...
    async getLeadUpdates() {
        try {
            ...
            let res$ = this.apiService.postReq(API_PATH.LEAD_UPDATES, { lead_id: this.leadID, search: this.search, page: this.updatepage, dateRange: this.selectedDate, type: 'updates' }, 'lead', 'list');
