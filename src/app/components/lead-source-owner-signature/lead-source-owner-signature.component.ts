...
@Component({
  selector: 'app-lead-source-owner-signature',
  templateUrl: './lead-source-owner-signature.component.html',
  styleUrls: ['./lead-source-owner-signature.component.scss']
})
export class LeadSourceOwnerSignatureComponent implements OnInit {
