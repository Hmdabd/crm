...
export class CompanyAddComponent implements OnInit {
    ...
    async addCompanySubmit(): Promise<void> {
        // this.router.navigate(['/admin/manage-company-permissions']);
        // return
        ...
        if (this.addCompanyForm.valid) {
            try {
                ...
                formData.append('submission_email', this.addCompanyForm.get('submission_email').value);
                ...
                formData.append('syndication_email', this.addCompanyForm.get('syndication_email').value);
                formData.append('support_email', this.addCompanyForm.get('support_email').value);
                formData.append('hub_sign', (this.addCompanyForm.get('hub_sign').value == true ? 1:0));
                ...
                if (response) {
                    if (response.data.user_already_exist_in_trash == 1) {
                        ...
                        this.router.navigate(['/admin/manage-company-permissions'], { queryParams: { company_id: response.data.user_id  , show: 'add'}});
