    ...
    */
    initAddComanyForm(): void {
        this.editCompanyForm = this.fb.group({
            ...
            city: ['', [Validators.required, Validators.pattern(Custom_Regex.spaces), Validators.maxLength(100),
                //  Validators.minLength(3)
            ]],
    ...
    patchValues() {
        this.editCompanyForm.patchValue({
            ...
            submission_email: this.companyDetails.submission_email,
            ...
            syndication_email: this.companyDetails.syndication_email,
            support_email: this.companyDetails.support_email,
            hub_sign: (this.companyDetails.hub_sign == 1 ? true : false),
    ...
    async editCompanySubmit() {
        ...
        if (this.editCompanyForm.valid) {
            try {
                ...
                formData.append('submission_email', this.editCompanyForm.get('submission_email').value);
                ...
                formData.append('syndication_email', this.editCompanyForm.get('syndication_email').value);
                formData.append('support_email', this.editCompanyForm.get('support_email').value);
                formData.append('hub_sign', (this.editCompanyForm.get('hub_sign').value == true ? 1 : 0));
                ...
                if (response) {
                    ...
                    this.router.navigate(['/admin/manage-company-permissions'], { queryParams: { company_id: this.companyID, show: 'edit' } });
