...
const routes: Routes = [
  {
    path: '', component: UserLayoutComponent, children: [
      ...
      // { path: 'lead-source-update/:id', component: LeadSourceUpdateComponent, canActivate: [RolePermission, AuthPermission], data: { role: Roles.UNDERWRITER, permission: 'lead-source-update' } },
      { path: 'lead-source-update/:id', component: LeadSourceUpdateComponent, canActivate: [RolePermission, AuthPermission], data: { permission: 'source-update' } },
      { path: 'syndicate-update/:id', component: SyndicateUpdateComponent, canActivate: [RolePermission, AuthPermission], data: { permission: 'syndicate-detail-update' } },
      // , AuthPermission], data: { permission: 'syndicate-detail-update'
      { path: 'lender-offer-update/:id', component: LenderOfferUpdateComponent, canActivate: [RolePermission, AuthPermission], data: { permission: 'lender-offer-update' } },
      // , AuthPermission], data: { permission: 'participant-update'
      { path: 'participant-update/:id', component: ParticipantUpdateComponent, canActivate: [RolePermission, AuthPermission], data: { permission: 'participant-update' } },
    ...
    {
      path: 'create-lead-affilate-link',
      component: CreateLeadAffilateLinkComponent,
      canActivate: [RolePermission],
      data: { role: Roles.UNDERWRITER, 
    },
