  ...
  */
        ...
        try {
            ...
            if (response && response.status_code == "200") {
                ...
                //   }
                  ...
                  this.assignedToUsers.sort((a,b)=> a.name.toLowerCase() > b.name.toLowerCase() ? 1:-1);
                console.log(this.assignedToUsers);
    ...
    async checkEmailTemplateExists(actionType: any) {
        ...
        try {
            ...
            if (response && response.status_code == "200") {
                // this.commonService.showSuccess(response.message);
                if (actionType == 'User Of CRM') {
                    this.router.navigate([`/${this.userBaseRoute}/user/add`]);
                }
