...
export const CONFIGURATIONS = {
    DEV: {
        ...
        ALLOWED_CSV_FILES: ['application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'xls', 'xlsx','text/csv'],
        LEAD_ID:'ld23wzxd'
    },
...
// amount:/^[+-]?[0-9]{1,3}(?:,?[0-9]{3})*\.[0-9]{2}$/,
    ...
    city: /^([a-zA-Z0-9])/,
    numberWithHypen:/^[0-9.-]+$/,
    amountWithNegativePositive:/^-?\d*\.{0,1}\d+$/,
    lettersWithSpecialChar:/^[a-zA-Z,,@!<>?+="'._`~{};#$%^&*)():/\\-]+$/,
    // /[a-zA-Z]+/,
    spaceBetweenWord:/\w+.*$/
}
