...
import { LeadSourceUpdateComponent } from '@components/lead-source-update/lead-source-update.component';
import { LeadSourceOwnerSignatureComponent } from '@components/lead-source-owner-signature/lead-source-owner-signature.component';
import { AllThanksMessageComponent } from '@components/all-thanks-message/all-thanks-message.component';
import { SyndicateUpdateComponent } from '@components/syndicate-update/syndicate-update.component';
import { SyndicateSignatureComponent } from '@components/syndicate-signature/syndicate-signature.component';
...
import { SyndicateSignature2Component } from '@components/syndicate-signature2/syndicate-signature2.component';
...
import { LenderOfferUpdateComponent } from '@components/lender-offer-update/lender-offer-update.component';
...
import { SafeHtmlPipe } from '@pipe/html-format-pipe';
import { LeadSubmissionUpdatesComponent } from '@components/lead/lead-submission-updates/lead-submission-updates.component';
...
import { DisclosuerSignaturePadComponent } from '@components/disclosuer-signature-pad/disclosuer-signature-pad.component';
...
import { HubSignaturePadComponent } from '@components/hub-signature-pad/hub-signature-pad.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ViewEditActivityComponent,
    LeadSourceUpdateComponent,
    LeadSourceOwnerSignatureComponent,
    AllThanksMessageComponent,
    SyndicateUpdateComponent,
    SyndicateSignatureComponent,
    SyndicateThanksMessageComponent,
    ParticipantUpdateComponent,
    SyndicateSignature2Component,
    SliderLimitsComponent,
    VerifyLenderOfferComponent,
    LenderOfferUpdateComponent,
    DocumentTypesComponent,
    EmailTemplatesTypesListingComponent,
    LeadSourceSettingListingComponent,
    PayrollSettingComponent,
    LeadSubmissionUpdatesComponent,
    DisclosureStatesComponent,
    DisclosuerLeadDetailComponent,
    DisclosuerSignaturePadComponent,
    PayrollSettingsAdminComponent,
    ContractSettingsComponent,
    PayrollListAdminComponent,
    ManageCompanyPermissionsComponent,
    HubSignComponent,
    HubSignaturePadComponent,
    AffiliateSignatureComponent,
