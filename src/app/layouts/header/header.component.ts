...
export class HeaderComponent implements OnInit {
    ...
    canViewSliderSettings: boolean = false;
    canEmailSettings: boolean = false;
    canDocumentsTypes: boolean = false;
    canViewIsoList: boolean = false
    canPayrollSetting: boolean = false;
    canViewDisclosureState: boolean = false;
    canViewContarctSetting: boolean = false;
    ...
    ngOnInit(): void {
        ...
        this.canViewIsoList = this.authService.hasPermission('ISO-list');
        ...
        this.canViewSliderSettings = this.authService.hasPermission('slider-settings');
        this.canEmailSettings = this.authService.hasPermission('email-template-type-list');
        this.canDocumentsTypes = this.authService.hasPermission('document-type-list');
        this.canPayrollSetting = this.authService.hasPermission('payroll-setting');
        this.canViewDisclosureState = this.authService.hasPermission('disclosure-state-list');
        this.canViewContarctSetting = this.authService.hasPermission('contract-setting');
    ...
    onimgerror(ref: any) {
        if (ref) {
            ...
            ref.src = 'assets/images/AdvanceHub_Logo.png'
        }
    }
    ...
    getUserDetails() {
        ...
        if (ud) {
            ...
            this.linkForm.patchValue({
                url: this.userDetails.affilate_link
            })
    ...
    ngAfterViewInit() {
        // if(this.predictiveSearch.nativeElement == undefined){
    ...
    affiliateLinkModal(templateRef: TemplateRef<any>) {
        try {
    ...
    copyTest(value: string) {
        this.commonService.copyText(value, 'Affiliate Link copied successfully')
    }
}
